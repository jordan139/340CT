...
public class Window23 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Window23.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
